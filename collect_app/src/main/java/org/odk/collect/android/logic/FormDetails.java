...
public class FormDetails implements Serializable {
    ...
    public void setManifestFileHash(String manifestFileHash) {
        this.manifestFileHash = manifestFileHash;
    }

    public void setNewerFormVersionAvailable(boolean newerFormVersionAvailable) {
        isNewerFormVersionAvailable = newerFormVersionAvailable;
    }

    public void setAreNewerMediaFilesAvailable(boolean areNewerMediaFilesAvailable) {
        this.areNewerMediaFilesAvailable = areNewerMediaFilesAvailable;
    }
}
