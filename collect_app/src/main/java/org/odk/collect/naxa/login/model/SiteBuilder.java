...
public class SiteBuilder {
    ...
    public SiteBuilder setTypeId(Integer typeId) {
        this.typeId = typeId;
        return this;
    }
    ...
    public Site createSite() {
        return new Site(id, latitude, longitude, identifier, name, typeId, typeLabel, phone, address, publicDesc, additionalDesc, logo, isActive, location, isSurvey, dateCreated, project, isSiteVerified, generalFormDeployedFrom, stagedFormDeployedFrom, scheduleFormDeployedForm);
    }
}