...
public class SiteListAdapterOld extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public SiteListAdapterOld(Context mContext, List<Site> sitelist, SiteListAdapterListener listener) {
