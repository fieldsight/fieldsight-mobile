...
public class WeeklyNotificationJob extends Job {

    public static final String TAG = "WeeklyNotificationJob";

    @NonNull
    @Override
    protected Result onRunJob(@NonNull Params params) {
        List<ScheduleForm> scheduleForms = ScheduledFormsLocalSource.getInstance().getDailyForms();
        String title = "Weekly Reminder";
    ...
    public static void schedule() {
        ...
        new JobRequest.Builder(WeeklyNotificationJob.TAG)
                .setPeriodic(TimeUnit.DAYS.toMillis(7), flexPeriod)
