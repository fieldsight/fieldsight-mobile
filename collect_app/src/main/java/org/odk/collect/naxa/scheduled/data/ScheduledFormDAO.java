...
public abstract class ScheduledFormDAO implements BaseDaoFieldSight<ScheduleForm> {
    ...
    @Query("SELECT * FROM scheduled_form WHERE siteId =:id AND formDeployedFrom= :formDeployedFrom")
    public abstract LiveData<List<ScheduleForm>> getBySiteId(String id, String formDeployedFrom);
