...
import org.bcss.collect.naxa.submissions.PaginationAdapter;

import java.util.ArrayList;
import java.util.List;

public class PaginatedSiteListAdapter extends PagedListAdapter<Site, RecyclerView.ViewHolder> {
    ...
    private final PaginatedSiteListAdapter.SiteListAdapterListener listener;
    private static int currentSelectedIndex = -1;
    private boolean reverseAllAnimations = false;

    private static DiffUtil.ItemCallback<Site> DIFF_CALLBACK = new DiffUtil.ItemCallback<Site>() {
        @Override
        public boolean areItemsTheSame(@NonNull Site site, @NonNull Site t1) {
            return site.getId().equals(t1.getId());
        }

        @Override
        public boolean areContentsTheSame(@NonNull Site site, @NonNull Site t1) {
            return site.equals(t1);
        }
    };

    PaginatedSiteListAdapter(List<Site> sitelist, PaginatedSiteListAdapter.SiteListAdapterListener listener) {
        super(DIFF_CALLBACK);
