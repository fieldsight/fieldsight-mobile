 ...
 */
public class FieldSightFormDownloadList extends FormListActivity implements FormListDownloaderListener,
    ...
    private FieldSightDownloadFormListTask downloadFormListTask;
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void granted() {
                ...
                try {
                    ...
                    DialogUtils.showDialog(DialogUtils.createErrorDialog(FieldSightFormDownloadList.this, e.getMessage(), EXIT), FieldSightFormDownloadList.this);
                    return;
                }
    ...
    private void init(Bundle savedInstanceState) {
        ...
        if (getLastCustomNonConfigurationInstance() instanceof DownloadFormListTask) {
            downloadFormListTask = (FieldSightDownloadFormListTask) getLastCustomNonConfigurationInstance();
