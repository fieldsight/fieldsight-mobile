...
public class SiteListFragmentOld extends Fragment implements SiteListAdapterOld.SiteListAdapterListener {
    ...
    private SiteListAdapterOld siteListAdapter;
    ...
    public static SiteListFragmentOld getInstance(String projectId, Project project) {

        Bundle bundle = new Bundle();
        bundle.putParcelable(EXTRA_OBJECT, project);
        SiteListFragmentOld siteListFragmentOld = new SiteListFragmentOld();
        siteListFragmentOld.setArguments(bundle);
        return siteListFragmentOld;
    }
    ...
    private void setupRecycleView() {
        ...
        siteListAdapter = new SiteListAdapterOld(getActivity(), sitelist, this);
