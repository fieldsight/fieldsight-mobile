...
public class FieldSightNotification implements Parcelable {
        ...
        public void setDeployedFromSite(boolean deployedFromSite) {
            isDeployedFromSite = deployedFromSite;
        }
        ...
        public static final Creator<org.bcss.collect.naxa.data.FieldSightNotification> CREATOR = new Creator<org.bcss.collect.naxa.data.FieldSightNotification>() {
            @Override
            public org.bcss.collect.naxa.data.FieldSightNotification createFromParcel(Parcel source) {
                return new org.bcss.collect.naxa.data.FieldSightNotification(source);
            }

            @Override
            public org.bcss.collect.naxa.data.FieldSightNotification[] newArray(int size) {
                return new org.bcss.collect.naxa.data.FieldSightNotification[size];
            }
        };
    }
